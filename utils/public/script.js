class App {
    ...
    async refreshQR() {
        ...
        refreshBtn.innerHTML = '<span class="material-icons">hourglass_empty</span>Refreshing...';
    ...
    showQRCode(qrData) {
        ...
        if (qrCodeImg && qrData) {
            ...
            qrCodeImg.onload = () => {
                ...
                this.showStatus('Scan the QR code with WhatsApp to authenticate', 'info');
            };
    ...
    showAuthorizedState() {
        ...
        this.showStatus('WhatsApp is already connected and ready to use', 'success');
    }
